...
import { hasProtocol, parseQuery, isEqual, joinURL, parseURL, withBase, withQuery } from 'file:///Users/emreugur/Documents/Dev/Code/Tree/node_modules/ufo/dist/index.mjs';
import { u as useRuntimeConfig$1 } from '../nitro/nitro-prerenderer.mjs';
import 'file:///Users/emreugur/Documents/Dev/Code/Tree/node_modules/h3/dist/index.mjs';
import 'file:///Users/emreugur/Documents/Dev/Code/Tree/node_modules/unenv/runtime/mock/proxy.mjs';
import 'stream';
import 'file:///Users/emreugur/Documents/Dev/Code/Tree/node_modules/node-fetch-native/dist/polyfill.mjs';
import 'file:///Users/emreugur/Documents/Dev/Code/Tree/node_modules/ohmyfetch/dist/node.mjs';
import 'file:///Users/emreugur/Documents/Dev/Code/Tree/node_modules/destr/dist/index.mjs';
import 'file:///Users/emreugur/Documents/Dev/Code/Tree/node_modules/radix3/dist/index.mjs';
import 'file:///Users/emreugur/Documents/Dev/Code/Tree/node_modules/unenv/runtime/fetch/index.mjs';
import 'file:///Users/emreugur/Documents/Dev/Code/Tree/node_modules/hookable/dist/index.mjs';
import 'file:///Users/emreugur/Documents/Dev/Code/Tree/node_modules/scule/dist/index.mjs';
import 'file:///Users/emreugur/Documents/Dev/Code/Tree/node_modules/ohash/dist/index.mjs';
import 'file:///Users/emreugur/Documents/Dev/Code/Tree/node_modules/unstorage/dist/index.mjs';
import 'file:///Users/emreugur/Documents/Dev/Code/Tree/node_modules/unstorage/dist/drivers/fs.mjs';
...
const components = {};
const _47Users_47emreugur_47Documents_47Dev_47Code_47Tree_47_46nuxt_47components_46plugin_46mjs = defineNuxtPlugin((nuxtApp) => {
...
const _47Users_47emreugur_47Documents_47Dev_47Code_47Tree_47node_modules_47nuxt_47dist_47head_47runtime_47lib_47vueuse_45head_46plugin = defineNuxtPlugin((nuxtApp) => {
...
const _47Users_47emreugur_47Documents_47Dev_47Code_47Tree_47node_modules_47nuxt_47dist_47head_47runtime_47plugin = defineNuxtPlugin((nuxtApp) => {
...
const _47Users_47emreugur_47Documents_47Dev_47Code_47Tree_47node_modules_47nuxt_47dist_47app_47plugins_47router = defineNuxtPlugin((nuxtApp) => {
...
const _plugins = [
  preload,
  _47Users_47emreugur_47Documents_47Dev_47Code_47Tree_47_46nuxt_47components_46plugin_46mjs,
  _47Users_47emreugur_47Documents_47Dev_47Code_47Tree_47node_modules_47nuxt_47dist_47head_47runtime_47lib_47vueuse_45head_46plugin,
  _47Users_47emreugur_47Documents_47Dev_47Code_47Tree_47node_modules_47nuxt_47dist_47head_47runtime_47plugin,
  _47Users_47emreugur_47Documents_47Dev_47Code_47Tree_47node_modules_47nuxt_47dist_47app_47plugins_47router
];
...
class TreeNode {
  ...
  addItem(item) {
    if (!this.isLeafNode())
      throw new Error("Can't add item to non leaf node!");
    if (this.isTwoNode()) {
    ...
    let nodes = [item, this.smallItem, this.largeItem].sort((a, b) => Number(a) - Number(b));
    let newNode = new TreeNode(nodes[1]);
    let newLeftNode = new TreeNode(nodes[0]);
    let newRightNode = new TreeNode(nodes[2]);
    newLeftNode.parent = newNode;
    newLeftNode.childType = 0;
    newRightNode.parent = newNode;
    newRightNode.childType = 1;
  ...
  pushNode(node) {
    if (!node.isTwoNode())
      throw new Error("Can't push a three node");
    if (this.isTwoNode()) {
      switch (node.childType) {
        ...
        case 1: {
          ...
          node.middleChild.parent = this;
          node.middleChild.childType = 2;
          this.rightChild = node.middleChild;
          node.leftChild.parent = this;
          node.leftChild.childType = 1;
    ...
    switch (node.childType) {
      case 0: {
        newNode = new TreeNode(this.smallItem);
        newLeftNode = new TreeNode(node.smallItem);
        newRightNode = new TreeNode(this.largeItem);
        newNode.parent = this.parent;
        newNode.childType = this.childType;
        newLeftNode.parent = newNode;
        newLeftNode.childType = 0;
      ...
      case 1: {
        newNode = new TreeNode(node.smallItem);
        newLeftNode = new TreeNode(this.smallItem);
        newRightNode = new TreeNode(this.largeItem);
        newNode.parent = this.parent;
        newNode.childType = this.childType;
        newLeftNode.parent = newNode;
      ...
      case 2: {
        newNode = new TreeNode(this.largeItem);
        newLeftNode = new TreeNode(this.smallItem);
        newRightNode = new TreeNode(node.smallItem);
        newNode.parent = this.parent;
        newNode.childType = this.childType;
        newLeftNode.parent = newNode;
        newLeftNode.childType = 0;
...
class Tree23 {
  ...
  drawTreeHelper(node, pos, radius, level, ctx) {
    if (!node)
      return;
    ...
    if (node.isTwoNode()) {
      ...
      if (node.leftChild) {
        ctx.beginPath();
        ctx.moveTo(pos.x, pos.y);
        ctx.lineTo(leftPos3.x, leftPos3.y);
        ctx.lineWidth = 5;
        ctx.strokeStyle = "#9dcded";
        ctx.stroke();
      }
      if (node.middleChild) {
        ctx.beginPath();
        ctx.moveTo(pos.x, pos.y);
        ctx.lineTo(middlePos3.x, middlePos3.y);
        ctx.lineWidth = 5;
        ctx.strokeStyle = "#9dcded";
        ctx.stroke();
      }
      if (node.rightChild) {
        ctx.beginPath();
        ctx.moveTo(pos.x, pos.y);
        ctx.lineTo(rightPos3.x, rightPos3.y);
        ctx.lineWidth = 5;
        ctx.strokeStyle = "#9dcded";
        ctx.stroke();
      }
  ...
  addItem(item, node) {
    ...
    if (item < node.smallItem)
      this.addItem(item, node.leftChild);
    else if (node.isTwoNode() || item < node.largeItem)
      this.addItem(item, node.middleChild);
    else
      this.addItem(item, node.rightChild);
  }
  handleSplits(node) {
    if (!node.parent) {
      this.root = node;
  ...
  checkTreeConnections(node) {
    if (!node)
      return;
    if (node.leftChild) {
      let c = node.leftChild;
      console.assert(c.childType == 0, "Wrong child type on", c);
      console.assert(c.parent == node, "Wrong parent on", c);
    }
    if (node.middleChild) {
      let c = node.middleChild;
      console.assert(c.childType == 1, "Wrong child type on", c);
      console.assert(c.parent == node, "Wrong parent on", c);
    }
    if (node.rightChild) {
      let c = node.rightChild;
      console.assert(c.childType == 2, "Wrong child type on", c);
      console.assert(c.parent == node, "Wrong parent on", c);
    }
    if (!node.isLeafNode) {
